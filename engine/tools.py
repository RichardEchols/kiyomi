...
def analyze_image(image_path: str, question: str = "") -> str:
    ...
    # CLI providers (claude-cli, gemini-cli, etc.) don't support direct image
    ...
    if provider.endswith("-cli"):
        ...
        if not found_fallback:
            return (
                f"Image analysis isn't available with CLI subscriptions alone.\n"
                f"Add a free-tier API key (Gemini recommended) in Kiyomi settings "
